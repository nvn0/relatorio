...
\begin{itemize}
    ...
    \item A \textit{shell} predefenida é o busybox;
    \item Gestor de pagotes é o "\texttt{apk}";
    \item Para executar comandos de forma administrativa é ncessário usar do comados "\texttt{doas}" em vez do "\texttt{sudo}".
\end{itemize} 
...
de solicitações \textit{HTTP} pela \textit{internet}. \\
