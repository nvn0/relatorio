...
O seguinte excerto de código mostra como funciona uma função no ficheiro "unixSocket.py" responsável
para se ligar à unix socket localizada em "/tmp/socket\_proj" e assim enviar os dados atrvés da mesma
para o "Port Controller".
