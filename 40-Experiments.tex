...
\title*{\textbf{Página de Login e Registo}}
...
De modo, evitar uso não autorizado de gestão de portas, existe uma página de 
\textit{login} deverá ser usada exclusivamente pelos
...
\title*{\textbf{Página para fazer pedidos sobre portas}}

\begin{figure}[H]
\begin{center}
\includegraphics[width=16cm]{figs/pedido2.png}
...
\title*{\textbf{Página para criar a ligação NAT}}
...
Para tal é necessário instalar as seguintes bibliotecas:
\begin{itemize}
